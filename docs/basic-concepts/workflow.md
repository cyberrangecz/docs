...
When the Training Instance is finished, the [results of the Training instance](../../user-guide/training-agenda/training-instance/#results-of-training-instance) are available and ready for the next evaluation.
