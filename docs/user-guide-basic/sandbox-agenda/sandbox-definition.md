...
![sandbox-definition-overview](/img/user-guide-basic/sandbox-agenda/sandbox-definition/sandbox-definition-overview.png){: .shadow .center .radius-image }
...
??? topology "Display topology"
    ...
    ![sandbox-topology](/img/user-guide-basic/sandbox-agenda/sandbox-definition/sandbox-definition-topology.png){: .shadow .center .radius-image }

??? trash-can "Delete"
    Click the button, and the following confirmation window will be opened:

    ![delete-sb](/img/user-guide-basic/sandbox-agenda/sandbox-definition/sandbox-definition-delete.png){: .shadow .center .radius-panel }

    !!! warning
        Only sandbox definitions not assigned to any pool can be deleted!

A new sandbox definition can be added by clicking on the ![Create button](/img/buttons/create-button.png){: .inline-button } button that redirects the instructor to the [Create Sandbox Definition](#create-sandbox-definition) page.
...
If these fields are correct, a new sandbox definition is created by clicking the ![Create button](/img/buttons/create-button.png){: .inline-button } button.

![create-sandbox-definition](/img/user-guide-basic/sandbox-agenda/sandbox-definition/sandbox-definition-create.png){: .shadow .center .radius-image }
