...
??? pencil "Edit"
    ...
    ![TD-edit-panel](/img/user-guide-basic/training-agenda/training-definition/TD-edit-panel.png){: .center .radius-image .shadow }
...
??? trash-can "Delete"
    ...
    ![TD-delete-panel](/img/user-guide-basic/training-agenda/training-definition/TD-delete-panel.png){: .center .radius-image .shadow style="max-height: 150px;" }
...
??? clone "Clone"
    ...
    ![TD-clone-panel](/img/user-guide-basic/training-agenda/training-definition/TD-clone-panel.png){: .center .radius-image .shadow style="max-height: 200px;" }
...
??? preview "Preview"
    ...
    ![TD-preview](/img/user-guide-basic/training-agenda/training-definition/TD-preview.png){: .center .radius-image .shadow }
...
![TD-create-panel](/img/user-guide-basic/training-agenda/training-definition/TD-create-panel.png){: .center .radius-image .shadow }
...
![TD-edit-levels](/img/user-guide-basic/training-agenda/training-definition/TD-edit-levels.png){: .center .radius-image .shadow style="height: 200px !important;"}

To add a new level, the instructor can click ![Add button](/img/buttons/add-button.png){: .inline-button } that will roll down a menu in which the instructor can choose a type of the new level:

![TD-levels](/img/user-guide-basic/training-agenda/training-definition/TD-levels.png){: .center .radius-image .shadow style="max-height: 200px;"}

Each change made inside a level must be saved with the ![Save button](/img/buttons/save-button.png){: .inline-button } button at the top of [Create Linear Training Definition Panel](#create-linear-training-definition-panel).
...
![TD-TL-panel](/img/user-guide-basic/training-agenda/training-definition/TD-TL-panel.png){: .center .radius-image .shadow }
...
![TD-hint-panel](/img/user-guide-basic/training-agenda/training-definition/TD-hint-panel.png){: .center .shadow .radius-image }

A new hint can be added with the ![Add button](/img/buttons/add-button.png){: .inline-button } button and edited with the following form. To change the order of hints, use the drag-and-drop mechanism.

![TD-hint-edit](/img/user-guide-basic/training-agenda/training-definition/TD-hint-edit.png){: .center  .shadow }
...
![TD-mitre-techniques-assign](/img/user-guide-basic/training-agenda/training-definition/TD-mitre-techniques-assign.png){: .center .radius-image .shadow }
...
![TD-expected-commands](/img/user-guide-basic/training-agenda/training-definition/TD-expected-commands.png){: .center .radius-image .shadow }
...
![TD-AL-panel](/img/user-guide-basic/training-agenda/training-definition/TD-AL-panel.png){: .center .radius-image .shadow }
...
![TD-questions-panel](/img/user-guide-basic/training-agenda/training-definition/TD-questions-panel.png){: .center .radius-image .shadow }

The instructor can choose to create a test or questionnaire, so the creation of the question may differ based on the type of assessment. A new question can be added with the ![Add button](/img/buttons/add-button.png){: .inline-button } button that will roll down the menu where the instructor can choose a type of the new question:

![TD-question](/img/user-guide-basic/training-agenda/training-definition/TD-question.png){: .center .radius-image .shadow }

Each type has its specific editing form.

![TD-FF-question](/img/user-guide-basic/training-agenda/training-definition/TD-FF-question.png){: .center .radius-image .shadow }

![TD-MC-question](/img/user-guide-basic/training-agenda/training-definition/TD-MC-question.png){: .center .radius-image .shadow }

![TD-EMI-question](/img/user-guide-basic/training-agenda/training-definition/TD-EMI-question.png){: .center .radius-image .shadow }

##### III. Info Level
In the _info level_, the trainees read the content of the information written by the instructor in the following form:

![TD-IL-panel](/img/user-guide-basic/training-agenda/training-definition/TD-IL-panel.png){: .center .radius-image .shadow }
...
![TD-ACL-panel](/img/user-guide-basic/training-agenda/training-definition/TD-ACL-panel.png){: .center .radius-image .shadow }
...
To upload a training definition, click in the **Linear Training Definition Overview** on the top right ![Upload button](/img/buttons/upload-button.png){: .inline-button } button. It will open the following window:

![TD-upload-panel](/img/user-guide-basic/training-agenda/training-definition/TD-upload-panel.png){: .center .radius-image .shadow  style="height: 300px;"}


Upload training definition that has been downloaded as a file in JSON format. This use case is useful when the instructor wants to re-use the training definition stored in the past. Try downloading and uploading an [example training definition](https://github.com/cyberrangecz/library-demo-training/blob/master/training.json) prepared by our team.
...
![Linear-definition-detail](/img/user-guide-basic/training-agenda/training-definition/TD-detail.png){: .center .radius-image .shadow }
...
![Assessment-level-detail](/img/user-guide-basic/training-agenda/training-definition/TD-detail-assessment-level.png){: .center .radius-image .shadow }
...
![Training-level-detail](/img/user-guide-basic/training-agenda/training-definition/TD-detail-training-level.png){: .center .radius-image .shadow }
